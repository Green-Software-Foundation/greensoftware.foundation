...
mainImage: "../images/green-software-foundation-expands-efforts-to-incentivize-decarbonization-in-t/main.png"
---
...
“At Globant, we understand technology’s impact on the environment and share the responsibility to support projects oriented to making our products and software greener. We need to adopt a carbon-oriented mindset with a renewed design approach to sustain transitions and curb emissions in every action we take.” - Santiago Fontanarrosa, VP of Technology at the Sustainable Business Studio at Globant

“The Green Software Foundation is building out the toolbox for the software practitioner of the future.”- Scott Chamberlin, Senior Director of Sustainability Software and Ecosystems, Intel Corporation

“Publishing SCI v1.0 is a huge step since measuring is essential for reducing. At the same time, reduction efforts must be executed, and the tools released should help those actions. IT system emissions are non-negligible, and we will continue to work hard to reduce them.” - Toru Shimogaki, Head of Green Innovation Office, NTT DATA

“The Green Software Foundation initiatives announced today will improve the tech ecosystem for all by building a shared understanding and empowering technologists with best practices and standards to measure their sustainability performance. It’s a great step forward on the start of a journey that is daunting in both how far we have to go, and how fast we have to get there.” - Elise Zelechowski, Global Head of DEI, Sustainability, and Social Change, Thoughtworks
