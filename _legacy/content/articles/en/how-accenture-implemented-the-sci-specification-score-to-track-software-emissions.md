...
mainImage: "../images/how-accenture-implemented-the-sci-specification-score-to-track-software-emissions/main.png"
---
...
![](../images/how-accenture-implemented-the-sci-specification-score-to-track-software-emissions/image.png)
...
Based on the CPU utilization of the nodes, we got the energy curves. Leveraging  [<u>third-party APIs</u>](https://www.climatiq.io/docs#cpu) from vendors like [<u>Climatiq</u>](https://www.climatiq.io/docs#cpu) also provides energy measurement based on parameters like utilization, region, and CPU (i.e., based on virtual cores used).
