...
mainImage: "../images/creating-a-digital-sustainability-ecosystem-meet-henry-chang-of-govtech-singapore/main.png"
---
...
4.     **Cybersecurity** – GovTech’s Cybersecurity Group monitors and detects threats in our government systems and networks and provides central tools and services to agencies to strengthen their security posture.
...
ii.              Integrating sustainable practices across our digital value chain, such as procurement, hardware use, software engineering, and end-of-life treatment

iii.             Harnessing digital innovation for sustainable outcomes

Some examples of our priorities under this three-pronged approach are:

·       Empowering our workforce with sustainability awareness and know-how

·       Incorporating sustainability criteria in our ICT tenders, to green our supply chain

·       Consolidating standalone server rooms, disparate data centers across different agencies and moving our workload into the cloud
...
With emerging green software capabilities, we can now green our common product offerings and the SG Tech Stack to systematically reduce the government’s digital carbon footprint. GovTech has published standards to support and guide agencies in the areas of governance, digital service design, and data management. Our next target is to develop a green software code of practice guide for our public agencies and support them in adopting green coding practices, tools, taking software carbon intensity and cloud carbon footprint measurements into consideration to improve utilization.     

Of course, we continue to push for migration to greener hosting options – first, the cloud, followed by our consolidated data centers. We have been on this arduous journey since 2020, when data centers contributed to about 7% of Singapore’s total electricity consumption. We are now on track to move 70% of eligible government workloads to the cloud by 2023.
...
The second challenge is the lack of awareness and understanding of green software and its impact. GovTech’s Digital Academy has begun curating specialized curriculums to uplift and enable our digital leaders and practitioners to make the right sustainable decisions. We wish to raise the digital sustainability quotient of all GovTech employees and, eventually, our peers in the Singapore government.
...
![](../images/creating-a-digital-sustainability-ecosystem-meet-henry-chang-of-govtech-singapore/image.png)
