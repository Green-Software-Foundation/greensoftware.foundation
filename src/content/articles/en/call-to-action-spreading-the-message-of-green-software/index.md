...
published: true
date: "2022-02-01"
summary: "In this new article series, Call to Action (CTA), Chris Lloyd-Jones discusses practical steps on spreading the message of green software, especially within organizations."
teaserText: "In Call to Action (CTA), a new article series, Chris Lloyd-Jones of Avanade discusses practical steps for spreading the message of green software  within organizations."
mainImage: "./main.png"
authors:
...
> There's a growing understanding of the need for organizations to "be green" or consider sustainability, but where should you start? Check this article for ideas and guidance. 
...
This concept isn't as radical as we may think. Software optimization used to be the norm, to fit limited memory, and compute; but the rise of infinitely elastic capacity (as far as your wallet will stretch) has, I'll admit it, made many developers lazy.

Yes, the best of our work optimizes to shrink website payload for faster load time, or we optimize software for Internet of Things Devices out in the wild and many other great examples. 

But I'd strongly rebut any idea that this optimization is the norm. That’s why we need change. 
...
The key factors we *can't *directly influence are creating organizational support and driving awareness of green software, especially within organizations. This takes me onto top-down organizational change and bottom-up advocacy at the grassroots.

## Building organizational support for change

Organizational support will be the biggest driver to support adoption. Without sponsorship and buy-in, it will be difficult to encourage teams and individuals to adopt new practices, or to take time away from current activities.
...
In 1977, Beckhard and Harris published a book about organizational transitions. Their "change equation" demonstrates that for change to take place, there has to be sufficient dissatisfaction with the old way of doing things.
...
It can also be helpful to think about what the negative outcomes of not making the change would be. What will happen to our organization and our teams if we don't green our software?

And change within organizations can go two ways: top-down and bottom up from grass roots. 

### Top-down change - actions you can take

Top-down change requires buy-in and support across an organization. Here are some pointers you could follow.

1. Consider the values that motivate your organization, or the drivers you see day to day; as well as what personally motivates you. One person can't do it all, but you can work on building momentum.
...
2. Having considered those factors, consider identifying a senior sponsor or sponsors in your organization that buy into these values. This person or persons can help to support the change, and help win support from across the business.
...
This might seem insurmountable. This might seem like a lot. Your organization might have a rigid approach to change, or you might not feel confident taking on the ingrained processes of a massive organization. But there is also another way!
...
The power of grassroots change is often heavily underestimated. But they influence the attitudes of those around us. Attitudes are formed through socialisation and exposure. By raising discussions around green software, sharing best practices, or by starting the conversation, we demonstrate a commitment to change. In doing so, we begin to create openness to changing practices in our peers. When attitudes change, we override our old attitudes and create new behaviors.

### How and where could you get started?

Change starts from within. Here are actions you could take, to start driving grassroots awareness within your organization.
...
- Reach out to the Green Software Foundation. [Consider putting yourself forward as a speaker yourself](https://greensoftware.foundation/projects/speakers), to talk about your experiences of driving Green Software at your organisation.
