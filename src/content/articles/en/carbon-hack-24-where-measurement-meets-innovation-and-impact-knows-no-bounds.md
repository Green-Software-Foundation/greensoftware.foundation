...
mainImage: "/assets/articles/carbon-hack-24-where-measurement-meets-innovation-and-impact-knows-no-bounds/main.jpg"
---

After a year of hard work getting green software into the mainstream lexicon, we’re bringing Carbon Hack back in 2024 from Monday, March 18 to Monday, April 8, 2024. The second edition of the hackathon is a competition that combines healthy rivalry with collaborative innovation to solve the biggest pain point facing the industry – measuring software for sustainability. 

[**Sign up to participate!**](https://grnsft.org/hack/articles) **|** [**Sign up for our upcoming live session**](https://grnsft.org/hack/live/articles)
...
The complexity of software systems has made impact measurement a Herculean task. As software's ecological impact inches toward a sizable [14%](https://hbr.org/2020/09/how-green-is-your-software), we need to improve our understanding of where across data centers, networks and devices we need to make changes to enhance efficiencies, clean code, and reduce carbon intensity.
...
At the core of this hackathon is [Impact Framework (IF)](https://if.greensoftware.foundation/), an alpha open source tool designed to help people comprehensively measure the environmental impacts of software – such as private cloud, public cloud, bare-metal, virtualized, containerized, mobile, laptops, and desktops. 

![Infographic explaining Impact Framework components: Models, Manifest File, and Impact Framework tool](/assets/articles/carbon-hack-24-where-measurement-meets-innovation-and-impact-knows-no-bounds/image.jpg)
...
[Become a sponsor](https://drive.google.com/file/d/1vyEOjc7Om-kbrrONzdN0piwJg9OZybXV/view?usp=drive_link). If you have questions, email us at [carbonhack@greensoftware.foundation](mailto:carbonhack@greensoftware.foundation).
