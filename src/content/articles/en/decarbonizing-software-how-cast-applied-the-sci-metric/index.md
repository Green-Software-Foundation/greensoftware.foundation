...
![CAST software architecture diagram showing desktop client, SaaS portal, database, storage, and external services](./image.jpg)
...
![SCI formula diagram: SCI equals E times I plus M per R, with annotations explaining each variable](./image.png)
