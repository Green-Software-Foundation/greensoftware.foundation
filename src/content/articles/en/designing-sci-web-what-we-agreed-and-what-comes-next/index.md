...
::button{href="/policy/research/sci-web-assembly-report/" label="Read the SCI for Web Assembly Report" variant="primary"}
...
Based on this evaluation (detailed in Section 9 of [the assembly report](/policy/research/sci-web-assembly-report/)) SCI for Web aims to complement existing tools by extending the parent SCI specification to web-specific contexts.
...
[**Read the full assembly report**](/policy/research/sci-web-assembly-report/) to see the detailed evaluation criteria, comparative analysis of existing frameworks, gaming prevention mechanisms, and detailed consensus positions on scope and target users.

::link-card{href="/policy/research/sci-web-assembly-report/" title="SCI for Web Assembly Report" description="The full consensus design document for SCI for Web, created by 14 GSF members through an AI-assisted assembly process."}
...
- **Join** [**the Software Standards Working Group**](https://directory.greensoftware.foundation/working-groups/software-wg/) and help shape the specification through draft review, implementation testing, and technical feedback.
