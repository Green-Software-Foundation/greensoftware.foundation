...
mainImage: "/assets/articles/events-es-experiences-project-of-the-green-software-foundation/main.png"
authors:
...
Our goals are to create inclusive, global experiences for Green Software Foundation members, developers, and technologists interested in sustainability. We are currently focused on our upcoming Green Software Foundation Global Summit in June 2022 and are looking to grow the GSF membership post-event.
...
Green Software Foundation members are on the core planning team, but non-members can get involved by attending, promoting, and helping with logistics if applicable. 

## What does a GSF member get from becoming involved in the project?

The Events & Experiences Team gains a vast network of technologists and leaders across the industry. We are able to network across the entire Foundation, as well as with all of the participants of the Summit. 

## What challenges do you see and how do you plan to overcome them?

The challenge, as with any volunteer-based project, is respecting people’s time and ability to contribute, while also achieving goals. The way to overcome these challenges is to be clear about the outcomes, the milestones, the deadlines, and keeping members engaged. 

When you are targeting global impact, you must empower others to take ownership of their work. We provide the playbooks, the resources, and the best practices, and then trust those to expand the experience in their own way.
...
## What else do you want to tell our readers about the GSF Global Summit? 
