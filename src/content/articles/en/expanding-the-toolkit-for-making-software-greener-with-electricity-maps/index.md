...
**Granularity of Data:** To measure scope 2 emissions effectively, software analysts need granular data reflecting the carbon intensity (i.e., gCO₂eq/kWh) at the location of their data centers and the time of use.
...
![Electricity Maps Data Portal showing free carbon intensity data downloads for countries including Australia, Austria, Belgium, and Brazil](./image.png)
...
2. You recognize how optimizing energy usage and shifting to cleaner energy sources can lower electricity bills, benefiting the environment, your customers, and your bottom line.

3. You choose to stay vigilant about regulatory compliance as more regions introduce rules and reporting requirements related to scope 2 emissions.

4. You are building a brand that lives environmental stewardship.
