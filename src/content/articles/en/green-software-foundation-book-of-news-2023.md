...
mainImage: "/assets/articles/green-software-foundation-book-of-news-2023/main.jpg"
---

The projects and initiatives we’re announcing reflect three big lessons we learned in the last 12 months:

1. Even with tools like the Carbon Aware SDK and the SCI Specification, reducing software's carbon emissions remains monumentally challenging for many organizations because many practitioners have yet to learn the skills to measure their baseline.
2. Nurturing micro-communities within organizations is an absolute imperative, and the foundation needs to play a larger role here as green software advocates need more support to build momentum internally.
3. Tools like the SCI Specification, though a big step forward in measuring the carbon emissions of software, have been difficult for many to adopt due to the complex nature of their systems.
