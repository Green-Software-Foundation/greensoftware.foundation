...
mainImage: "/assets/articles/meet-savannah-goodman-of-google/main.png"
---
...
- Our [carbon-intelligent platform](https://blog.google/outreach-initiatives/sustainability/carbon-aware-computing-location/) uses day-ahead predictions to time and location shift flexible compute tasks.
- Investment in research to optimize resources and reduce carbon, including research on how to reduce resources for [machine learning](https://ieeexplore.ieee.org/abstract/document/9810097). 
...
- We are continuing to improve our [carbon-aware computing capabilities](https://blog.google/outreach-initiatives/sustainability/carbon-aware-computing-location/) so that we can shift workloads in time and space. This allows us to minimize our carbon footprint and support grid needs by providing demand response.
- We’ve helped develop [Cloud](https://cloud.google.com/carbon-footprint) and [Workspace](https://support.google.com/a/answer/13761003) Carbon Footprint solutions, enabling customers to measure and reduce their footprint by using Google services.
- We created an [insights platform](https://cloud.google.com/blog/topics/sustainability/new-programs-and-tools-for-sustainable-transformation) that enables Cloud customers to baseline their carbon-free energy score and develop an optimized energy portfolio. 
- We’ve developed tooling for [granular energy attribute certificates](https://cloud.google.com/blog/topics/sustainability/t-eacs-help-drive-around-the-clock-carbon-free-energy) that enable hourly electricity tracking and incentivize the deployment of flexible carbon-free technologies.

# Where do you see yourself adding value to the GSF mission?
We are excited to participate by actively contributing to several GSF working groups. We are eager to leverage learnings and research related to our carbon-aware compute platform to contribute to the standards working group as well as to some of the relevant open-source projects, such as the [Carbon Aware SDK](https://github.com/Green-Software-Foundation/carbon-aware-sdk) and [Impact Engine Framework](https://github.com/Green-Software-Foundation/carbon-ql). We’d also like to share the sustainability developer principles we’ve developed for Google Cloud customers and the learnings from developing our [Carbon Sense Suite](https://cloud.google.com/sustainability).

![Green Software Foundation and Google logos on a nature-themed illustration](/assets/articles/meet-savannah-goodman-of-google/image.png)
