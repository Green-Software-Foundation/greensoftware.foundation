...
mainImage: "/assets/articles/meet-sunil-aggarwal-hcltech/main.jpg"
---
...
1. **Lack of awareness and understanding of green software.** Many developers and businesses are unaware of the environmental impact of software or the benefits of green software development.
2. **Lack of standards and metrics**. Currently, there is no single, universally accepted standard for measuring the environmental impact of software, making it difficult to compare different software solutions and track progress over time.
3. **Lack of tools and frameworks**. There are not enough tools and frameworks available to help developers build green software. This complicates the process and makes it more time-intensive.
...
HCLTech has also launched a sustainability school where around 100k employees are getting training on sustainability guidelines. Our team is fully aligned with the [Green Software Foundation Practitioner Course](https://learn.greensoftware.foundation/).

![Green Software Foundation and HCLTech logos on a dark nature-themed illustration](/assets/articles/meet-sunil-aggarwal-hcltech/image.jpg)
