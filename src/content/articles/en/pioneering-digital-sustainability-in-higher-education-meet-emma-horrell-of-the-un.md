...
We began this journey by [investigating methods for measuring website weight and carbon emissions.](https://blogs.ed.ac.uk/website-communications/how-green-can-we-make-the-ux-service-website-using-digital-sustainability-data-to-drive-user-centred-design-decisions/) Rather than waiting for a perfect strategy, we've adopted a "learning by doing" approach. Our digital estate comprises numerous individual websites, each managed by different teams responsible for content creation, updates, and promotion.

A standout success was our homepage image optimization project. We discovered our image formats were unnecessarily heavy, and through simple changes, [achieved 13 tonnes of CO2 ](https://blogs.ed.ac.uk/website-communications/a-case-study-of-the-homepage-13-tonnes-of-carbon-saved-through-sustainable-web-design-choices/)reduction per year. 

Our strategy is to identify areas for improvement and document our findings through [case study blog posts](https://blogs.ed.ac.uk/website-communications/category/sustainability/) that others can learn from.
...
For instance, the Software Sustainability Institute (SSI), led by [EPCC](https://www.epcc.ed.ac.uk/) in partnership with the Universities of Manchester and Southampton, recently [secured £10.2m funding](https://www.ed.ac.uk/news/2024/ps10-2m-bid-to-enable-sustainable-research-softwar) to focus on the environmental sustainability of research software. 
