...
mainImage: "/assets/articles/real-time-cloud-ratified-a-major-step-toward-transparent-sustainable-cloud-comput/main.png"
---

## What Ratification of the Real Time Cloud Means for Green Software
...
- As part of the initial work, multiple sources, interfaces, and products that collect and report energy and carbon data have been documented in [a large Miro flow](https://miro.com/app/board/uXjVM1o59N4=/?share_link_id=388311040102).  
...
We plan to release slowly changing reference data through [the GSF Impact Framework](https://github.com/Green-Software-Foundation/if). So far, this includes Power Usage Efficiency (PUE), Water Usage Efficiency (WUE), Carbon-Free Energy, a placeholder for EU Datacenter disclosure data, and information on Power Purchase Agreement locations.
...
<figure>
<img src="/assets/articles/real-time-cloud-ratified-a-major-step-toward-transparent-sustainable-cloud-comput/real-time-cloud-miro-flow-july-2024.png" alt="Miro board mapping cloud energy and carbon data sources, interfaces, and reporting products across providers" />
...
We are currently seeking contributions to produce the best estimate of region metadata for the current year for anyone to use. To contribute to and learn more, we invite you to visit [the GitHub issue.](https://github.com/Green-Software-Foundation/real-time-cloud/issues/72)
...
To contribute to our work, [become a member](https://greensoftware.foundation/join-us).
