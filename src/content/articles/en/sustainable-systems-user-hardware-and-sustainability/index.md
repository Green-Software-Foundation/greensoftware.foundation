...
![Bar-chart-showing-Emissions-per-ICT-end-User-device-Hardware-Sustainability-Anne-Currie-Green-Software-Foundation](./bar-chart-showing-emissions-per-ict-end-user-device-hardware-sustainability-anne-currie-green-software-foundation.png)
