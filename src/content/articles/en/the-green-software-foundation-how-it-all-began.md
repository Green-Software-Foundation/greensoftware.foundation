...
mainImage: "/assets/articles/the-green-software-foundation-how-it-all-began/main.png"
authors:
...
## Tell us how the push for green software started 

I run what we call Developer Relations at [Microsoft.](https://www.microsoft.com/) Developer relations is a very specialized type of organization. A lot of companies do not have developer relations. Microsoft has the biggest developer relations organization in the world. Our responsibility is to connect with software developer audiences all over the world. 
...
We realized very early on that there was a need for knowledge. There was a deep lack of knowledge specifically regarding software and sustainability. What do we need to do? There's a lot of stuff around kind of hardware and sustainability, but there really wasn't much on software sustainability. So that was one of the first things we did.
...
![Jeff-sandquist-microsoft-quote-about-green-software-foundation](/assets/articles/the-green-software-foundation-how-it-all-began/jeff-sandquist-microsoft-quote-about-green-software-foundation.png)

## Let us talk about the key areas that the Foundation is working on

### One of the most important things is standards.
...
Through our work at Microsoft and connecting with communities, we see the benefits of developer communities all over the world. To expand and grow the field of green software, we need a large community of green software practitioners. These would be people who care passionately about the subject, talk about the subject and have training on the subject. We need to come to a stage where green software practitioners can be hired by companies in order to make their applications green.  

We need to grow the community beyond the 100 or so people in the world who are knowledgeable in the subject right now. We need thousands upon thousands upon thousands of people who we would consider to be part of the green software community. So that's why GSF has a community working group to grow that aspect of it.
...
But the challenge in the green spaces is that we have very little tooling available for people who want to build green software. That’s why GSF has an innovation working group to figure out how we can build that ecosystem of tooling. Then it becomes easier for people to build green software.  
...
## Read what individual Steering Committee Members say about green software:

[Elise Zelechowski ](https://greensoftware.foundation/articles/meet-our-steering-committee-elise-zelechowski)of Thoughtworks

[Erica Brescia](https://greensoftware.foundation/articles/meet-a-steering-committee-member-erica-brescia) of GitHub
