...
mainImage: "/assets/articles/the-green-software-foundation-releases-alpha-version-of-software-carbon-intensity/main.png"
authors:
...
1. **Use less hardware**; such as reducing the size of upgrades to enable users to keep their old devices longer, or architecting cloud applications to use fewer machines.
2. **Use less energy**; such as improving the speed of users’ task completion or server performance so that software runs more efficiently and consumes fewer resources.
3. Or do more when energy supply is cleaner and less when energy supply is dirtier, which is known as **carbon awareness**. An example is scheduling routine backups to occur during peak times of solar energy supply.
