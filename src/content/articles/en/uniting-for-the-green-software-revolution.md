...
mainImage: "/assets/articles/uniting-for-the-green-software-revolution/main.png"
---

[On June 5 for World Environment Day, GSF hosted a live virtual event for tech enthusiasts interested to know how software can help save the planet. Attendees joined GSF experts to hear about the current ](https://grnsft.org/events/UNwed)[<u>state of green software</u>](https://stateof.greensoftware.foundation/), the challenges and opportunities ahead, and the best practices and tools to make code more eco-friendly. Over 200 practitioners (a number that would have once shocked us, [<u>but not any more</u>](https://stateof.greensoftware.foundation/insights/92-percent-of-software-practitioners-are-concerned-about-climate-change/)) across the globe participated and raised questions about a broad set of issues, from cloud computing to tools for sustainable AI. 
...
#### [*Watch our Green Software Revolution event on YouTube.*](https://grnsft.org/events/UNwed)

# [What GSF Stands For](https://grnsft.org/events/UNwed)

The Green Software Foundation focuses on how we can build software with zero harmful environmental effects. The GSF is the global community of developers and organizations committed to making software more sustainable. Together we are building a trusted ecosystem of [<u>people</u>](https://greensoftware.foundation/working-groups/community), [<u>standards</u>](https://greensoftware.foundation/working-groups/standards), [<u>tooling</u>](https://greensoftware.foundation/working-groups/opensource)<u>,</u> and [<u>best practices</u>](https://greensoftware.foundation/projects/software-carbon-intensity-sci-specification) for Green Software.
...
A full recording of the event can be found [<u>here</u>](https://grnsft.org/events/UNwed).

# Expert's Top-Picked Insights

### [**Carbon aware software is central to decarbonization**](https://stateof.greensoftware.foundation/insights/carbon-aware-software-central-to-decarbonization/)
...
### [**Responsible AI is green AI **](https://stateof.greensoftware.foundation/insights/responsible-ai-is-green-ai/)
...
### [**63% of CEOs do not rate sustainability as a top priority**](https://stateof.greensoftware.foundation/insights/63-percent-of-ceo-do-not-rate-sustainability-as-a-top-priority/)
...
### [**Decarbonization alone cannot make software green **](https://stateof.greensoftware.foundation/insights/decarbonization-alone-cannot-make-software-green/)
...
[<u>State of Green Software Report</u>](https://stateof.greensoftware.foundation/)

[<u>Green Software Practitioner Course</u>](https://grnsft.org/course)

[<u>Environment Variables Podcast</u>](https://podcast.greensoftware.foundation/)

[<u>GSF Newsletter Signup</u>](https://greensoftware.foundation/)
