...
In April 2026, more than a dozen institutional investors pressed major technology companies for more detailed disclosure on data-center water and power use ahead of annual shareholder meetings. (1) Investors are increasingly treating water as a material disclosure dimension rather than solely a supporting sustainability indicator, and are seeking greater transparency on water alongside carbon.   
...
Recent scenario-based analysis suggests AI-related infrastructure globally could consume several hundred billion litres of water annually, with upper-bound estimates approaching the annual global consumption of bottled water. (2) In Texas, a January 2026 white paper by the Houston Advanced Research Center estimates data-center water use at around 25 billion gallons in 2025, with annual consumption projected to rise to between 29 and 161 billion gallons by 2030—potentially representing up to 2.7 per cent of the state's total water use. (3) A medium-sized data center consumes roughly 110 million gallons per year—about the use of a thousand households. A large hyperscale facility can consume up to five million gallons in a single day. (4)

These figures are estimates, and while the wide ranges reflect genuine uncertainty, the scale is clear. Many data centres rely on evaporative cooling, where a substantial share of withdrawn water is consumed through evaporation rather than returned to local watersheds. A further portion is consumed indirectly, through the water needed to generate the electricity those facilities draw from the grid. And a third portion sits even further upstream, in the water-intensive process of fabricating the chips that make AI possible. Three sources of consumption mean three different reporting approaches, often by three different organizations—and no consensus on how to bring them together into a metric that supports fair comparison.
