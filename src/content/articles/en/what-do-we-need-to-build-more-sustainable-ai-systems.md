...
There is a significant lack of richness in the input data sources today. Only a few regions in the world have well-stocked datasets with real-time updates provided by suppliers like [WattTime](https://www.watttime.org/) and [ElectricityMap](https://app.electricitymap.org/). For others, we’re left with static, coarse data in often non-interoperable and non-machine-readable formats from government data sources. This gets in the way of actionable insights to those who want to alter their energy consumption patterns, such as scheduling AI training jobs at greener periods of the day and regions of the world.
...
There is a significant gap today in mapping the needs of practitioners: we need to better understand how the tools are utilized in the wild and what needs to change to increase their adoption. One gap, as identified above, was how the current tools are not native to the workflow of practitioners. [Code-based tools](https://codecarbon.io) have started to address some of these gaps and are now entering the phase that other hyperparameter and experiment-tracking tools and frameworks have done for the AI community over time: making them a normalized practice by being deeply native to the everyday workflows of practitioners. 
...
If you’d like to learn more about why sustainable AI systems are important, we encourage you to check out “[The Imperative for Sustainable AI systems](https://thegradient.pub/sustainable-ai/)” and stay in touch with the Green Software Foundation as we release standards and tooling to help you build more sustainable software systems. 
