...
mainImage: "/assets/articles/what-s-shaking-at-the-gsf-a-summer-of-milestones/main.jpg"
---
...
## Unveiling the [State of Green Software](https://stateof.greensoftware.foundation/): bringing insights and data to the forefront to decarbonize software at scale

In May, we unveiled the groundbreaking State of Green Software report, a unique digital publication that sheds light on global insights and data crucial for decarbonizing software at scale. Breaking away from conventional industry reports, it offers bite-sized "insight bytes" on green software adoption, recent academic research, leading decarbonization tools, and the evolving policy landscape. The report shows how [<u>Green Software is vital for a net zero future</u>](https://stateof.greensoftware.foundation/insights/green-software-vital-for-net-zero/) and provides a clear [<u>business case</u>](https://stateof.greensoftware.foundation/insights/green-software-business-case/) for any practitioner looking to get a green software project green-lit or proof points for investing more in green software.

Explore the [<u>State of Green Software</u>](https://stateof.greensoftware.foundation/).
...
This project is housed under the [<u>Open Source Working Group</u>](https://greensoftwarefoundation.atlassian.net/wiki/spaces/~612dd45e45cd76006a84071a/pages/852049/Open+Source+Working+Group), currently chaired by Chris Lloyd-Jones from Avanade and Dan Lewis-Toakley from Thoughtworks. 

To learn more about the Impact Engine Framework Project, click [<u>**here**</u>](https://greensoftwarefoundation.atlassian.net/wiki/spaces/~612dd45e45cd76006a84071a/pages/17072136/Opensource+Impact+Engine+Framework).
...
Part of the [<u>Standards Working Group,</u>](https://greensoftwarefoundation.atlassian.net/wiki/spaces/~612dd45e45cd76006a84071a/pages/819277/Standards+Working+Group) our new project aims to set a standard for measuring carbon emissions, moving away from monthly reporting to minute-by-minute metrics  for all cloud providers.
...
Express your interest in joining the core team [<u>**here**</u>](https://github.com/orgs/Green-Software-Foundation/discussions/34).
...
The newly released Version 1.1 adds new features, supporting [<u>ElectricityMaps</u>](https://www.electricitymaps.com/) as a new data source (both paid and free APIs), and improves quality of usage and stability. The Carbon Aware SDK can now also provide a library for DLL import usage to integrate within a project without the need to deploy an API.

Learn more about the Carbon Aware SDK v.1.1 [<u>**here**</u>](https://github.com/Green-Software-Foundation/carbon-aware-sdk). 
...
Join GSF Discussions – start by [<u>saying hi </u>](https://github.com/orgs/Green-Software-Foundation/discussions/2)👋🏽
...
To learn more about the GSF and how you can get involved, click [<u>**here**</u>](https://greensoftwarefoundation.atlassian.net/l/cp/opoh1vLV). 
...
If you’re interested in contributing and writing an article for the GSF, click [<u>**here**</u>](https://greensoftwarefoundation.atlassian.net/l/cp/aEbA1yc1). 
