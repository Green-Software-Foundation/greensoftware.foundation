        ...
        links: [
          {
            ...
            label: "SCI",
            description:
              "ISO-certified metric for software carbon intensity" /* iconSrc: pi("sci"), icon: "target" */,
          },
          {
            href: "/standards/sci-ai/",
            label: "SCI for AI",
            description:
              "Carbon measurement for AI systems" /* iconSrc: pi("sci-ai"), icon: "bot" */,
          },
          {
            href: "/standards/sci-web/",
            label: "SCI for Web",
            description:
              "Carbon measurement for web applications" /* iconSrc: pi("sci-web"), icon: "globe" */,
          },
          {
            href: "/standards/soft/",
            label: "SOFT",
          ...
          },
          {
            ...
            label: "SWE",
            description:
              "Software Water Efficiency" /* iconSrc: pi("swe"), icon: "droplets" */,
          },
        ],
      },
      {
        ...
        links: [
          {
            ...
            label: "Certification",
            description:
              "Get certified in green software specifications" /* iconSrc: pi("sci-certification"), icon: "award" */,
          },
          {
            href: "/assemblies/",
            label: "Assemblies",
            description:
              "AI-facilitated consensus at scale" /* icon: "messages-square" */,
          },
        ],
      },
    ],
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        headerLink: {
          href: "/policy/",
          label: "About our policy & research →",
        },
        links: [
          {
      ...
      },
      {
        ...
        links: [
          ...
          },
          {
            ...
            /* iconSrc: pi("carmen"), icon: "calculator", */
          },
          {
        ...
        links: [
          {
            ...
            description: "Practitioner-focused podcast",
            /* iconSrc: pi("environment-variables-podcast"), icon: "mic", */ external: true,
          },
          {
            href: "https://wiki.greensoftware.foundation/cxo-bytes-podcast",
            label: "CXO Bytes",
            description: "C-suite focused podcast",
            /* iconSrc: pi("cxo-bytes-podcast"), icon: "mic", */ external: true,
          },
        ],
      },
      {
    ...
    sections: [
      {
        ...
        links: [
          ...
          {
            href: "/governance/",
            label: "Governance & Leadership" /* icon: "shield" */,
          },
          { href: "/brand/", label: "Brand & Assets" /* icon: "palette" */ },
          { href: "/contact/", label: "Contact" /* icon: "mail" */ },
          {
            href: "https://directory.greensoftware.foundation/members",
            label: "Member Directory",
            /* icon: "users", */ external: true,
          },
          {
      ...
      },
      {
        ...
        links: [
          ...
          {
            href: "https://wiki.greensoftware.foundation/orientation",
            label: "Member Onboarding",
            /* icon: "handshake", */ external: true,
          },
          {
            href: "https://wiki.greensoftware.foundation/register",
            label: "Employee Registration",
            description: "Register to join working groups and initiatives",
            /* icon: "users", */ external: true,
          },
        ],
      },
