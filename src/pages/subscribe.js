...
const SubscribePage = ({ data: { allDatoCmsProjectV2: { nodes } } }) => {
  ...
  const projects = nodes.map(node => { return ({ name: node.name, url: node.url }) }).sort(
          ...
          >
            ...
            <div className="checkboxes-wrapper">
              ...
              <div className="flex-align-center">
                ...
                <a href="https://standards.greensoftware.foundation/" target="_blank"
              ...
              <div className="flex-align-center">
                ...
                <a href="https://policy.greensoftware.foundation/" target="_blank"
                  rel="noopener noreferrer"
                  className="external-link"
                >
                  <ExternalLink />
              ...
              <div className="flex-align-center">
                ...
                <a href="https://opensource.greensoftware.foundation/" target="_blank"
                  rel="noopener noreferrer"
                  className="external-link"
                >
                  <ExternalLink />
              ...
              <div className="flex-align-center">
                ...
                <a href="https://community.greensoftware.foundation/" target="_blank"
                  rel="noopener noreferrer"
                  className="external-link"
                >
                  <ExternalLink />
